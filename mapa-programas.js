    ...
    CHILDS: [
      {
        ...
        HTML:
          `Esta es una aplicación que desarrollé como trabajo de la universidad, 
                    para la asignatura de estructura de datos, es un algoritmo muy básico y muy 
                    limitado, que dado un estado inicial ` +
          HTMLlightboxLaTeX("X_0", "", "Cadenas de markov") +
          ` y una matriz de 
  ...
  },
  {
    ...
    CHILDS: [
      ...
      },
      {
        ...
        HTML:
          "Dados dos puntos en el espacio, se puede determinar una ecuación " +
          HTMLlightboxLaTeX(
